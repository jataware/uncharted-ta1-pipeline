...
class Pipeline:
    ...
    def __init__(self, id:str, name:str, output:list[OutputCreator], tasks:list[Task] = []) -> None:
        self._tasks = tasks
        self._output = output
        self.id = id
        self.name = name
    ...
    def run(self, input: PipelineInput) -> PipelineResult:
        ...
        for t in self._tasks:
            ...
            try:
                ...
                print(f'EXCEPTION executing pipeline at step {task_input.task_index} for raster {input.raster_id}')
                print(e)
    ...
    def _merge_result(self, pipeline_result:PipelineResult, task_result:TaskResult) -> PipelineResult:
        # override result
    ...
    def _create_task_input(self, task_index:int, pipeline_input:PipelineInput, pipeline_result:PipelineResult) -> TaskInput:
