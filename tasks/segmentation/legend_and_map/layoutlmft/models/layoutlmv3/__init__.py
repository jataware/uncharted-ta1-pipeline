...
AutoModelForTokenClassification.register(Layout_LMv3Config, Layout_LMv3ForTokenClassification)
AutoModelForQuestionAnswering.register(Layout_LMv3Config, Layout_LMv3ForQuestionAnswering)
AutoModelForSequenceClassification.register(Layout_LMv3Config, Layout_LMv3ForSequenceClassification)
AutoTokenizer.register(
    Layout_LMv3Config, slow_tokenizer_class=Layout_LMv3Tokenizer, fast_tokenizer_class=Layout_LMv3TokenizerFast
)
