...
class TaskParameter:
    ...
    def __init__(self, task_id:str, task_index:int, key:str, category:str, value:any, description:str = ''):
...
class TaskInput:
    ...
    def add_param(self, task_id:str, key:str, category:str, value:any, description:str = ''):
        self.params_used.append(TaskParameter(task_id, self.task_index, key, category, value, description))
...
class Task:
    ...
    def _add_param(self, input:TaskInput, key:str, category:str, value:any, description:str = ''):
