...
docker pull uncharted/lara-cdr:$1
docker pull uncharted/lara-georef:$1
docker pull uncharted/lara-point-extract:$1
docker pull uncharted/lara-segmentation:$1
docker pull uncharted/lara-metadata-extract:$1
